  ...
  try {
    ...
    for (let i = 0; i < blobs.length; i++) {
      ...
      if (
        ...
        pdf.setFillColor(255, 255, 255); // sky blue
        pdf.rect(
          0,
          yOffset,
      ...
      if (i < blobs.length - 1) {
        ...
        if (
          ...
          if (img.height / pdf.internal.pageSize.getHeight() < 1) {
            pdf.addImage(
              img,
              "PNG",
              10,
            ...
            yOffset += 20 + img.height * scaleFactor;
          } else {
            pdf.addImage(
              img,
              "PNG",
            ...
            yOffset += 20 + (img.height * heightScaleFactor * 19) / 20;
          }
        }
      } else {
        // last
